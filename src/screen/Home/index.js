...
const Home = (props) => {
    ...
    const getTodoData = async () => {
        let defaultToDoData = [
            { title: 'Design Team meeting', deadline: "2022-04-21", start_time: "2022-04-14T13:23:30.822Z", end_time: "2022-04-14T11:54:30.822Z", reminder: "10", repeat: "Daily", check: true, color: Utils.getRandomColor() },
            { title: 'Making Wireframes', deadline: "2022-04-21", start_time: "2022-04-14T13:23:30.822Z", end_time: "2022-04-14T11:54:30.822Z", reminder: "10", repeat: "Daily", check: false, color: Utils.getRandomColor() },
            { title: 'Create UI elements', deadline: "2022-04-21", start_time: "2022-04-14T13:23:30.822Z", end_time: "2022-04-14T11:54:30.822Z", reminder: "10", repeat: "Daily", check: false, color: Utils.getRandomColor() },
            { title: 'Meeting with Murman Khvadadze', deadline: "2022-04-21", start_time: "2022-04-14T13:23:30.822Z", end_time: "2022-04-14T11:54:30.822Z", reminder: "10", repeat: "Daily", check: false, color: Utils.getRandomColor() }]

        let getTodoData = await AsyncStorage.getItem('@todoData');
        if (getTodoData != null) {
            getTodo(JSON.parse(getTodoData));
        } else {
            await AsyncStorage.setItem('@todoData', JSON.stringify(defaultToDoData));
            let getTodoData = await AsyncStorage.getItem('@todoData');
            getTodo(JSON.parse(getTodoData));
        }
    }
